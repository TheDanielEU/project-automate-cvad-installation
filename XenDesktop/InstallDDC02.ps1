<#
.SYNOPSIS
InstallDDC02.ps1 - Script for installing Citrix XenDesktop.
...
.LINK
    https://github.com/TheDanielEU/project-automate-cvad-installation/Installscripts/XenDesktop/InstallDDC02.ps1
#>
$Vendor = "Citrix"
$Product = "XenDesktop"
